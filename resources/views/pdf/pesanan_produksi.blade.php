        ...
        <div class="grid-2">
            ...
            <div class="col">
                <table class="detail">
                    ...
                    <tr><td><strong>Deadline Produksi</strong></td><td>: {{ \Carbon\Carbon::parse($pesanan->adjusted_deadline)->format('d M Y') }}</td></tr>
